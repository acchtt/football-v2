...
const SHELL=[
  ...
  asset('manifest.webmanifest?v=11'),
  asset('icons/arc-xi.svg?v=2'),
  asset('icons/arc-xi-192.svg?v=2'),
  asset('icons/arc-xi-512.svg?v=2'),
  asset('icons/arc-xi-maskable-512.svg?v=2'),
...
self.addEventListener('message',event=>{
  ...
  if(event.data?.type==='TEST_NOTIFICATION'){
    event.waitUntil(self.registration.showNotification('ARC XI test',{
      ...
      icon:asset('icons/arc-xi-192.svg?v=2'),
      badge:asset('icons/arc-xi-192.svg?v=2'),
