...
const SHELL=[
  ...
  asset('manifest.webmanifest?v=12'),
  asset('icons/arc-xi-64.png?v=1'),
  asset('icons/arc-xi-192.png?v=1'),
  asset('icons/arc-xi-512.png?v=1'),
  asset('icons/arc-xi-maskable-512.png?v=1'),
...
self.addEventListener('message',event=>{
  ...
  if(event.data?.type==='TEST_NOTIFICATION'){
    event.waitUntil(self.registration.showNotification('ARC XI test',{
      ...
      icon:asset('icons/arc-xi-192.png?v=1'),
      badge:asset('icons/arc-xi-192.png?v=1'),
