...
const SHELL=[
  ...
  asset('manifest.webmanifest?v=13'),
  asset('icons/arc-xi.svg?v=3'),
  asset('icons/arc-xi-192.svg?v=3'),
  asset('icons/arc-xi-512.svg?v=3'),
  asset('icons/arc-xi-maskable-512.svg?v=3'),
...
self.addEventListener('message',event=>{
  ...
  if(event.data?.type==='TEST_NOTIFICATION'){
    event.waitUntil(self.registration.showNotification('ARC XI test',{
      ...
      icon:asset('icons/arc-xi-192.svg?v=3'),
      badge:asset('icons/arc-xi-192.svg?v=3'),
