(() => {
  ...
  function header() {
    ...
    return '<header class="appHeader"><div class="headerInner">' +
      '<a class="brand" href="#board"><span class="brandMark"><img src="./icons/arc-xi-64.png?v=1" alt=""></span><span class="brandWords"><b>ARC XI</b><small>Live football · Match intelligence</small></span></a>' +
